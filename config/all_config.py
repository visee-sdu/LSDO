...
class AllConfig(Config):
    ...
    def parse_args(self):
        ...
        parser.add_argument('--num_mha_heads', type=int, default=1,
                            help='Number of parallel heads in multi-headed attention')
        parser.add_argument('--transformer_dropout', type=float, default=0.3,
                            help='Dropout prob. in the transformer pooling')
        ...
        parser.add_argument('--scene_path', type=str, default='./scene/vscene.json', help='the path of shared scene')
        parser.add_argument('--select_frame', type=int, default='6', help='the select frame in single scene')
        parser.add_argument('--threshold', type=float, default='-0.1', help='the threshold in single scene')
        parser.add_argument('--scene_type', type=str, default='average', help='shared, single or average')
