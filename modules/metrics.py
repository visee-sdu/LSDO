...
def sim_matrix_inference(text_embeds_per_video_id, vid_embeds_pooled_per_video_id):
    """
    ...
    vid_embeds_pooled_per_video_id = vid_embeds_pooled_per_video_id.view(num_vids * max_text_per_vid, embed_dim,
                                                                         num_vids)
...
def generate_embeds_per_video_id(text_embeds, vid_embeds_pooled, all_vid_ids):
